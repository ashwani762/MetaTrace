...
<template>
  <div data-tour="graph" class="h-full w-full flex flex-col bg-gray-900 min-h-0 relative">
    ...
    <div v-if="traceSteps.length > 0" data-tour="timeline" class="absolute bottom-4 left-1/2 transform -translate-x-1/2 w-3/4 max-w-xl flex items-center justify-between bg-gray-900/85 backdrop-blur border border-gray-700/60 rounded-full py-1.5 px-4 shadow-xl z-20 space-x-3">
